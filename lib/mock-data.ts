...
export const MOCK_PRODUCTS: MockProduct[] = [
  ...
  },
  {
    ...
    era: 'MODERN',
    year: 2023,
    description: "L'artisanat automobile italien dans ce qu'il a de plus pur. V12 Biturbo AMG de 730 ch sous châssis Carbo-Titane, immortalisé en relief 3D à côté de son modèle échelle 1.",
    price: 49.99,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    era: 'MODERN',
    year: 2022,
    description: "Le rugissement du V12/V10 atmosphérique à 8 700 tr/min. Cadre 3D relief avec rétroéclairage LED ambré et finitions d'artisanat d'art.",
    price: 49.99,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    era: 'MODERN',
    year: 2023,
    description: "Teinte mythique Isle of Man Green et calandre verticale acérée. Réalisation 3D haut de gamme sous vitrage acrylique de précision.",
    price: 49.99,
    isActive: true,
    isFeatured: true,
    images: ['/atelier/WhatsApp Image 2026-09-08 at 13.47.10.jpeg'],
    variants: [{ id: 'var-m4comp', sku: 'DF-BMW-M4COMP', stock: 5, stockAlert: 2 }],
  },
  {
    id: 'mock-senna',
